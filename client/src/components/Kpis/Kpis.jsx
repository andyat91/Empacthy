...
export default function Kpis({ deleteClick }){
    ...
    const news = [
        {
        title:"Las empresas españolas aumentan un 3% su inversión en acción social, hasta los 1.533 millones en 2021.",
        photo:inversion,
        ...
        {
        title:"El Parlamento Europeo aprueba la Ley de Restauración de la Naturaleza a 100 días de las elecciones europeas.",
        ...
        {
        title:"El Gobierno aprueba por decreto la reforma de la ley de mecenazgo.",
        photo:macerazgo,
